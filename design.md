...
A *entity template* `<entity>.html` maps to an *entity*. An *entity template* accepts a *template entity*.
...
A *repository function* runs database queries. A *repository function* has the following syntax.
```
